#ifndef CAFFE_RANK_NET_CROSS_ENTROPY_LOSS_LAYER_HPP_
#define CAFFE_RANK_NET_CROSS_ENTROPY_LOSS_LAYER_HPP_
...
class RankNetCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
  explicit RankNetCrossEntropyLossLayer(const LayerParameter& param)
 ...
 protected:
  /// @copydoc RankNetCrossEntropyLossLayer
...
#endif  // CAFFE_RANK_NET_CROSS_ENTROPY_LOSS_LAYER_HPP_
